...
FILE="monte-carlo.csv"
PROG="main"

echo -n "" > $FILE

echo "size,1,2,4,8,10,16,20,24,30,35,40" >> $FILE
...
run () {
    ...
    echo "$LEN,$ONE,$TWO,$FOUR,$EIGHT,$TEN,$SEXTEEN,$TWENTY,$TWENTYFOUR,$THIRTY,$THIRTYFIVE,$FORTY" >> $FILE
}

export LEN=1000000
./compile.sh pi_${LEN}.cpp
run
